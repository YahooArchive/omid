...
public class TestBatch {
    ...
    public void testBatchFunctionality() {
        ...
        assertFalse("Batch shouldn't be full", batch.isFull());
        assertEquals("Num events should be 1", 1, batch.getNumEvents());
        ...
        assertTrue("Batch should be full", batch.isFull());
        assertEquals("Num events should be " + BATCH_SIZE, BATCH_SIZE, batch.getNumEvents());
        ...
        try {
            ...
            assertEquals("message returned doesn't match", "batch full", e.getMessage());
