...
public abstract class TSOClient {
    ...
    public static final String ZK_CONNECTION_TIMEOUT_IN_MS_CONFKEY = "tso.zk.connection.timeout-secs";
    public static final int DEFAULT_ZK_CONNECTION_TIMEOUT_IN_MS = 10;
