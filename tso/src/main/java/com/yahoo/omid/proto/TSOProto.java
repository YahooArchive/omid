...
public final class TSOProto {
  ...
  public interface RequestOrBuilder
    ...
    // optional .TimestampRequest timestampReq = 1;
    boolean hasTimestampReq();
    com.yahoo.omid.proto.TSOProto.TimestampRequest getTimestampReq();
    com.yahoo.omid.proto.TSOProto.TimestampRequestOrBuilder getTimestampReqOrBuilder();
    
    // optional .CommitRequest commitReq = 2;
    boolean hasCommitReq();
    com.yahoo.omid.proto.TSOProto.CommitRequest getCommitReq();
    com.yahoo.omid.proto.TSOProto.CommitRequestOrBuilder getCommitReqOrBuilder();
  }
  public static final class Request extends
    ...
    // optional .TimestampRequest timestampReq = 1;
    public static final int TIMESTAMPREQ_FIELD_NUMBER = 1;
    private com.yahoo.omid.proto.TSOProto.TimestampRequest timestampReq_;
    public boolean hasTimestampReq() {
      return ((bitField0_ & 0x00000001) == 0x00000001);
    }
    public com.yahoo.omid.proto.TSOProto.TimestampRequest getTimestampReq() {
      return timestampReq_;
    }
    public com.yahoo.omid.proto.TSOProto.TimestampRequestOrBuilder getTimestampReqOrBuilder() {
      return timestampReq_;
    }
    
    // optional .CommitRequest commitReq = 2;
    public static final int COMMITREQ_FIELD_NUMBER = 2;
    private com.yahoo.omid.proto.TSOProto.CommitRequest commitReq_;
    public boolean hasCommitReq() {
      return ((bitField0_ & 0x00000002) == 0x00000002);
    }
    public com.yahoo.omid.proto.TSOProto.CommitRequest getCommitReq() {
      return commitReq_;
    }
    public com.yahoo.omid.proto.TSOProto.CommitRequestOrBuilder getCommitReqOrBuilder() {
      return commitReq_;
    }
    
    private void initFields() {
      timestampReq_ = com.yahoo.omid.proto.TSOProto.TimestampRequest.getDefaultInstance();
      commitReq_ = com.yahoo.omid.proto.TSOProto.CommitRequest.getDefaultInstance();
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000001) == 0x00000001)) {
        output.writeMessage(1, timestampReq_);
      }
      if (((bitField0_ & 0x00000002) == 0x00000002)) {
        output.writeMessage(2, commitReq_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000001) == 0x00000001)) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, timestampReq_);
      }
      if (((bitField0_ & 0x00000002) == 0x00000002)) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, commitReq_);
      }
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        super.clear();
        if (timestampReqBuilder_ == null) {
          timestampReq_ = com.yahoo.omid.proto.TSOProto.TimestampRequest.getDefaultInstance();
        } else {
          timestampReqBuilder_.clear();
        }
      ...
      public com.yahoo.omid.proto.TSOProto.Request buildPartial() {
        ...
        if (timestampReqBuilder_ == null) {
          result.timestampReq_ = timestampReq_;
        } else {
          result.timestampReq_ = timestampReqBuilder_.build();
        }
        if (((from_bitField0_ & 0x00000002) == 0x00000002)) {
          to_bitField0_ |= 0x00000002;
        }
        if (commitReqBuilder_ == null) {
          result.commitReq_ = commitReq_;
        } else {
          result.commitReq_ = commitReqBuilder_.build();
        }
      ...
      public Builder mergeFrom(com.yahoo.omid.proto.TSOProto.Request other) {
        ...
        if (other.hasTimestampReq()) {
          mergeTimestampReq(other.getTimestampReq());
        }
        if (other.hasCommitReq()) {
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 10: {
              ...
              if (hasTimestampReq()) {
                subBuilder.mergeFrom(getTimestampReq());
              }
              input.readMessage(subBuilder, extensionRegistry);
              setTimestampReq(subBuilder.buildPartial());
              break;
            }
            case 18: {
              com.yahoo.omid.proto.TSOProto.CommitRequest.Builder subBuilder = com.yahoo.omid.proto.TSOProto.CommitRequest.newBuilder();
              if (hasCommitReq()) {
                subBuilder.mergeFrom(getCommitReq());
              }
              input.readMessage(subBuilder, extensionRegistry);
              setCommitReq(subBuilder.buildPartial());
              break;
            }
          }
        }
      ...
      // optional .TimestampRequest timestampReq = 1;
      private com.yahoo.omid.proto.TSOProto.TimestampRequest timestampReq_ = com.yahoo.omid.proto.TSOProto.TimestampRequest.getDefaultInstance();
      private com.google.protobuf.SingleFieldBuilder<
          com.yahoo.omid.proto.TSOProto.TimestampRequest, com.yahoo.omid.proto.TSOProto.TimestampRequest.Builder, com.yahoo.omid.proto.TSOProto.TimestampRequestOrBuilder> timestampReqBuilder_;
      public boolean hasTimestampReq() {
        return ((bitField0_ & 0x00000001) == 0x00000001);
      }
      public com.yahoo.omid.proto.TSOProto.TimestampRequest getTimestampReq() {
        if (timestampReqBuilder_ == null) {
          ...
          return timestampReqBuilder_.getMessage();
        }
      }
      public Builder setTimestampReq(com.yahoo.omid.proto.TSOProto.TimestampRequest value) {
        if (timestampReqBuilder_ == null) {
          if (value == null) {
          ...
          timestampReqBuilder_.setMessage(value);
        }
        bitField0_ |= 0x00000001;
        return this;
      }
      public Builder setTimestampReq(
          com.yahoo.omid.proto.TSOProto.TimestampRequest.Builder builderForValue) {
        if (timestampReqBuilder_ == null) {
          timestampReq_ = builderForValue.build();
          onChanged();
        } else {
          timestampReqBuilder_.setMessage(builderForValue.build());
        }
        bitField0_ |= 0x00000001;
        return this;
      }
      public Builder mergeTimestampReq(com.yahoo.omid.proto.TSOProto.TimestampRequest value) {
        if (timestampReqBuilder_ == null) {
          if (((bitField0_ & 0x00000001) == 0x00000001) &&
              timestampReq_ != com.yahoo.omid.proto.TSOProto.TimestampRequest.getDefaultInstance()) {
            timestampReq_ =
              com.yahoo.omid.proto.TSOProto.TimestampRequest.newBuilder(timestampReq_).mergeFrom(value).buildPartial();
          } else {
            timestampReq_ = value;
          }
          onChanged();
        } else {
          timestampReqBuilder_.mergeFrom(value);
        }
        bitField0_ |= 0x00000001;
        return this;
      }
      public Builder clearTimestampReq() {
        if (timestampReqBuilder_ == null) {
          timestampReq_ = com.yahoo.omid.proto.TSOProto.TimestampRequest.getDefaultInstance();
          onChanged();
        } else {
      ...
      public com.yahoo.omid.proto.TSOProto.TimestampRequest.Builder getTimestampReqBuilder() {
        bitField0_ |= 0x00000001;
        onChanged();
        return getTimestampReqFieldBuilder().getBuilder();
      }
      public com.yahoo.omid.proto.TSOProto.TimestampRequestOrBuilder getTimestampReqOrBuilder() {
        if (timestampReqBuilder_ != null) {
          return timestampReqBuilder_.getMessageOrBuilder();
        } else {
          return timestampReq_;
        }
      }
      private com.google.protobuf.SingleFieldBuilder<
          ...
          getTimestampReqFieldBuilder() {
        if (timestampReqBuilder_ == null) {
          timestampReqBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              com.yahoo.omid.proto.TSOProto.TimestampRequest, com.yahoo.omid.proto.TSOProto.TimestampRequest.Builder, com.yahoo.omid.proto.TSOProto.TimestampRequestOrBuilder>(
                  timestampReq_,
        ...
        return timestampReqBuilder_;
      }
      
      // optional .CommitRequest commitReq = 2;
      private com.yahoo.omid.proto.TSOProto.CommitRequest commitReq_ = com.yahoo.omid.proto.TSOProto.CommitRequest.getDefaultInstance();
      private com.google.protobuf.SingleFieldBuilder<
          com.yahoo.omid.proto.TSOProto.CommitRequest, com.yahoo.omid.proto.TSOProto.CommitRequest.Builder, com.yahoo.omid.proto.TSOProto.CommitRequestOrBuilder> commitReqBuilder_;
      public boolean hasCommitReq() {
        return ((bitField0_ & 0x00000002) == 0x00000002);
      }
      public com.yahoo.omid.proto.TSOProto.CommitRequest getCommitReq() {
      ...
      public Builder setCommitReq(com.yahoo.omid.proto.TSOProto.CommitRequest value) {
        if (commitReqBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setCommitReq(
        ...
        if (commitReqBuilder_ == null) {
          commitReq_ = builderForValue.build();
          onChanged();
        } else {
      ...
      public Builder mergeCommitReq(com.yahoo.omid.proto.TSOProto.CommitRequest value) {
        if (commitReqBuilder_ == null) {
          if (((bitField0_ & 0x00000002) == 0x00000002) &&
              commitReq_ != com.yahoo.omid.proto.TSOProto.CommitRequest.getDefaultInstance()) {
            commitReq_ =
              com.yahoo.omid.proto.TSOProto.CommitRequest.newBuilder(commitReq_).mergeFrom(value).buildPartial();
          } else {
            commitReq_ = value;
          }
          onChanged();
      ...
      public com.yahoo.omid.proto.TSOProto.CommitRequest.Builder getCommitReqBuilder() {
        bitField0_ |= 0x00000002;
        onChanged();
      ...
      private com.google.protobuf.SingleFieldBuilder<
          ...
          getCommitReqFieldBuilder() {
        if (commitReqBuilder_ == null) {
          commitReqBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              com.yahoo.omid.proto.TSOProto.CommitRequest, com.yahoo.omid.proto.TSOProto.CommitRequest.Builder, com.yahoo.omid.proto.TSOProto.CommitRequestOrBuilder>(
                  commitReq_,
                  getParentForChildren(),
                  isClean());
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_Request_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_Request_descriptor,
              new java.lang.String[] { "TimestampReq", "CommitReq", },
