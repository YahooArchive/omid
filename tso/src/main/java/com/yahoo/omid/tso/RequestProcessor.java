...
class RequestProcessor implements EventHandler<RequestProcessor.RequestEvent>
{
    ...
    RequestProcessor(long firstTimestamp, WALProcessor walProcessor, ReplyProcessor replyProcessor) {
        this.reply = replyProcessor;
